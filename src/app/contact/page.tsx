...
function page() {
	...
	return (
		<div className="min-h-screen bg-gray-100 dark:bg-gray-900 py-12 pt-24 relative">
			{" "}
			...
			<div className="max-w-2xl mx-auto p-4 relative z-10">
				...
				<h1 className="text-lg md:text-7xl text-center font-sans font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-b from-blue-900 to-neutral-400">
					Contact Us
				</h1>
				...
				<form className="my-8" onSubmit={handleSubmit}>
					...
					<LabelInputContainer className="mb-4">
						...
						<textarea
							name="msg"
							id="msg"
							className="bg-gray-900 border border-gray-200 rounded-md"
						></textarea>
					</LabelInputContainer>
